...
public final class EntityMetaFields {
    ...
    public static class Entity implements IEntityMetaFieldHolder {
        ...
        public static final SimpleField<Integer> AIR_SUPPLY = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 1, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Optional<Component>> CUSTOM_NAME = SimpleField.<Optional<Component>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 2, EntityDataTypes.OPTIONAL_ADV_COMPONENT)
            .build();
        ...
        public static final SimpleField<Boolean> CUSTOM_NAME_VISIBLE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 3, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> NO_GRAVITY = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 5, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<EntityPose> POSE = SimpleField.<EntityPose>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 6, EntityDataTypes.ENTITY_POSE)
            .build();
        ...
        public static final ViewField<Byte, EntitySharedFlagsView> SHARED_FLAGS = ViewField.builder(EntitySharedFlagsView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 0, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Boolean> SILENT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_26_2, 4, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> TICKS_FROZEN = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 7, EntityDataTypes.INT)
            .build();
    ...
    public static class AbstractArrow extends Projectile {
        ...
        public static final ViewField<Byte, AbstractArrowIdFlagsView> ID_FLAGS = ViewField.builder(AbstractArrowIdFlagsView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Boolean> IN_GROUND = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 10, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Optional<UUID>> OWNERUUID = SimpleField.<Optional<UUID>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_15, 8, EntityDataTypes.OPTIONAL_UUID)
            .build();
        ...
        public static final SimpleField<Byte> PIERCE_LEVEL = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_15, 9, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 8, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 9, EntityDataTypes.BYTE)
            .build();
    ...
    public static class VehicleEntity extends Entity {
        ...
        public static final SimpleField<Float> DAMAGE = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_20_3, ClientVersion.V_26_2, 10, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Integer> HURT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_3, ClientVersion.V_26_2, 8, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> HURTDIR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_3, ClientVersion.V_26_2, 9, EntityDataTypes.INT)
            .build();
    ...
    public static class AbstractBoat extends VehicleEntity {
        ...
        public static final SimpleField<Integer> BUBBLE_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 13, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Boolean> PADDLE_LEFT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 11, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> PADDLE_RIGHT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 12, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class LivingEntity extends Entity {
        ...
        public static final SimpleField<Integer> ARROW_COUNT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 11, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 12, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Boolean> EFFECT_AMBIENCE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 10, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 11, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> EFFECT_COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 9, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_3, 10, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<List<Particle<?>>> EFFECT_PARTICLES = SimpleField.<List<Particle<?>>>builder()
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_26_2, 10, EntityDataTypes.PARTICLES)
            .build();
        ...
        public static final SimpleField<Float> HEALTH = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 9, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Optional<Vector3i>> SLEEPING_POS = SimpleField.<Optional<Vector3i>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 12, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 13, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 14, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .build();
        ...
        public static final SimpleField<Integer> STINGER_COUNT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 12, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 13, EntityDataTypes.INT)
            .build();
    ...
    public static class Mob extends LivingEntity {
        ...
        public static final SimpleField<Byte> MOB_FLAGS = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 13, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 14, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 15, EntityDataTypes.BYTE)
            .build();
    ...
    public static class AgeableMob extends PathfinderMob {
        ...
        public static final SimpleField<Boolean> AGE_LOCKED = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 17, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> BABY = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class AbstractHorse extends Animal {
        ...
        public static final ViewField<Byte, AbstractHorseFlagsView> FLAGS = ViewField.builder(AbstractHorseFlagsView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 17, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Optional<UUID>> OWNER_UUID = SimpleField.<Optional<UUID>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 18, EntityDataTypes.OPTIONAL_UUID)
            .build();
    ...
    public static class AbstractChestedHorse extends AbstractHorse {
        ...
        public static final SimpleField<Boolean> CHEST = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class AbstractCubeMob extends AgeableMob {
        ...
        public static final SimpleField<Integer> ID_SIZE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_26_2, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class AbstractFish extends WaterAnimal {
        ...
        public static final SimpleField<Boolean> FROM_BUCKET = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class AbstractMinecart extends VehicleEntity {
        ...
        public static final SimpleField<Boolean> CUSTOM_DISPLAY = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 12, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 13, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> CUSTOM_DISPLAY_BLOCK = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_26_2, 11, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .build();
         ...
         */
        public static final SimpleField<Float> DAMAGE = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 9, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_2, 10, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Integer> DISPLAY_BLOCK = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 10, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 11, EntityDataTypes.INT)
            .build();
         ...
         */
        public static final SimpleField<Integer> HURT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_2, 8, EntityDataTypes.INT)
            .build();
         ...
         */
        public static final SimpleField<Integer> HURTDIR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_2, 9, EntityDataTypes.INT)
            .build();
    ...
    public static class TamableAnimal extends Animal {
        ...
        public static final SimpleField<Optional<UUID>> OWNERUUID = SimpleField.<Optional<UUID>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 18, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 18, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.OPTIONAL_UUID)
            .build();
    ...
    public static class AbstractNautilus extends TamableAnimal {
        ...
        public static final SimpleField<Boolean> DASH = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_1_21_11, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class AbstractPiglin extends Monster {
        ...
        public static final SimpleField<Boolean> IMMUNE_TO_ZOMBIFICATION = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16_2, ClientVersion.V_1_16_2, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class ThrowableItemProjectile extends ThrowableProjectile {
        ...
        public static final SimpleField<ItemStack> ITEM_STACK = SimpleField.<ItemStack>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.ITEMSTACK)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.ITEMSTACK)
            .build();
    ...
    public static class AbstractVillager extends AgeableMob {
        ...
        public static final SimpleField<Integer> UNHAPPY_COUNTER = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class Allay extends PathfinderMob {
        ...
        public static final SimpleField<Boolean> CAN_DUPLICATE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19_1, ClientVersion.V_26_2, 17, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> DANCING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19_1, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class AreaEffectCloud extends Entity {
        ...
        public static final SimpleField<Integer> COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_3, 9, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Particle<?>> PARTICLE = SimpleField.<Particle<?>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 10, EntityDataTypes.PARTICLE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_3, 11, EntityDataTypes.PARTICLE)
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_26_2, 10, EntityDataTypes.PARTICLE)
            .build();
        ...
        public static final SimpleField<Float> RADIUS = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Boolean> WAITING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 9, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_20_3, 10, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_26_2, 9, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Armadillo extends Animal {
        ...
        public static final SimpleField<ArmadilloState> ARMADILLO_STATE = SimpleField.<ArmadilloState>builder()
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.ARMADILLO_STATE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.ARMADILLO_STATE)
            .build();
    ...
    public static class ArmorStand extends LivingEntity {
        ...
        public static final SimpleField<Vector3f> BODY_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 17, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Vector3f> HEAD_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Vector3f> LEFT_ARM_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 18, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Vector3f> LEFT_LEG_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 20, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Vector3f> RIGHT_ARM_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 19, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Vector3f> RIGHT_LEG_POSE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 19, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 20, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 21, EntityDataTypes.VECTOR3F)
            .build();
    ...
    public static class Arrow extends AbstractArrow {
        ...
        public static final SimpleField<Integer> ID_EFFECT_COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_15, 10, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 9, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 10, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 11, EntityDataTypes.INT)
            .build();
    ...
    public static class Avatar extends LivingEntity {
        ...
        public static final SimpleField<HumanoidArm> PLAYER_MAIN_HAND = SimpleField.<HumanoidArm>builder()
            ...
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_26_2, 15, EntityDataTypes.HUMANOID_ARM)
            .build();
        ...
        public static final ViewField<Byte, AvatarPlayerModeCustomizationFlagsView> PLAYER_MODE_CUSTOMISATION = ViewField.builder(AvatarPlayerModeCustomizationFlagsView::new)
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 16, EntityDataTypes.BYTE)
            .build();
    ...
    public static class Axolotl extends Animal {
         ...
         */
        public static final SimpleField<Boolean> FROM_BUCKET = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> PLAYING_DEAD = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Bat extends AmbientCreature {
        ...
        public static final ViewField<Byte, BatFlagsView> FLAGS = ViewField.builder(BatFlagsView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BYTE)
            .build();
    ...
    public static class Bee extends Animal {
        ...
        public static final SimpleField<Long> ANGER_END_TIME = SimpleField.<Long>builder()
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_1_21_11, 18, EntityDataTypes.LONG)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.LONG)
            .build();
        ...
        public static final SimpleField<Integer> ANGER_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_15, 17, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> REMAINING_ANGER_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_9, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class Display extends Entity {
        ...
        public static final ViewField<Byte, DisplayBillboardView> BILLBOARD_RENDER_CONSTRAINTS = ViewField.builder(DisplayBillboardView::new)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 14, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 15, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Integer> BRIGHTNESS_OVERRIDE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 16, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> GLOW_COLOR_OVERRIDE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 21, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 22, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Float> HEIGHT = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 20, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 21, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Integer> INTERPOLATION_DURATION = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 9, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> INTERPOLATION_START_DELTA_TICKS = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 8, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Quaternion4f> LEFT_ROTATION = SimpleField.<Quaternion4f>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 12, EntityDataTypes.QUATERNION)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_1_21_9, 13, EntityDataTypes.QUATERNION)
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_26_2, 13, EntityDataTypes.QUATERNION)
            .build();
        ...
        public static final SimpleField<Integer> POS_ROT_INTERPOLATION_DURATION = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 10, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Quaternion4f> RIGHT_ROTATION = SimpleField.<Quaternion4f>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 13, EntityDataTypes.QUATERNION)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_1_21_9, 14, EntityDataTypes.QUATERNION)
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_26_2, 14, EntityDataTypes.QUATERNION)
            .build();
        ...
        public static final SimpleField<Vector3f> SCALE = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 11, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_1_21_9, 12, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_26_2, 12, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Float> SHADOW_RADIUS = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 17, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 18, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Float> SHADOW_STRENGTH = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 18, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 19, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Integer> TRANSFORMATION_INTERPOLATION_DURATION = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 9, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> TRANSFORMATION_INTERPOLATION_START_DELTA_TICKS = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 8, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Vector3f> TRANSLATION = SimpleField.<Vector3f>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 10, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_1_21_9, 11, EntityDataTypes.VECTOR3F)
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_26_2, 11, EntityDataTypes.VECTOR3F)
            .build();
        ...
        public static final SimpleField<Float> VIEW_RANGE = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 16, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 17, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Float> WIDTH = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 19, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 20, EntityDataTypes.FLOAT)
            .build();
    ...
    public static class BlockDisplay extends Display {
        ...
        public static final SimpleField<Integer> BLOCK_STATE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 22, EntityDataTypes.BLOCK_STATE)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 23, EntityDataTypes.BLOCK_STATE)
            .build();
    ...
    public static class Boat extends AbstractBoat {
         ...
         */
        public static final SimpleField<Integer> BUBBLE_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 13, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 14, EntityDataTypes.INT)
            .build();
         ...
         */
        public static final SimpleField<Boolean> PADDLE_LEFT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 11, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 12, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> PADDLE_RIGHT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 12, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 13, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> TYPE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 10, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 11, EntityDataTypes.INT)
            .build();
    ...
    public static class Bogged extends AbstractSkeleton {
        ...
        public static final SimpleField<Boolean> SHEARED = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Camel extends AbstractHorse {
         ...
         */
        public static final SimpleField<Boolean> DASH = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19_3, ClientVersion.V_1_19_3, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Long> LAST_POSE_CHANGE_TICK = SimpleField.<Long>builder()
            .addVersionRange(ClientVersion.V_1_19_3, ClientVersion.V_1_19_3, 20, EntityDataTypes.LONG)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 19, EntityDataTypes.LONG)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.LONG)
            .build();
    ...
    public static class Cat extends TamableAnimal {
        ...
        public static final SimpleField<Integer> COLLAR_COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 21, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 22, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 23, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Boolean> IS_LYING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 20, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> RELAX_STATE_ONE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 20, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 21, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 22, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<CatSoundVariant> SOUND_VARIANT = SimpleField.<CatSoundVariant>builder()
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 24, EntityDataTypes.CAT_SOUND_VARIANT)
            .build();
         ...
         */
        public static final SimpleField<Integer> TYPE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_17, 19, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<CatVariant> VARIANT = SimpleField.<CatVariant>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_20_3, 19, EntityDataTypes.TYPED_CAT_VARIANT)
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_1_21_11, 19, EntityDataTypes.TYPED_CAT_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.TYPED_CAT_VARIANT)
            .build();
    ...
    public static class Chicken extends Animal {
        ...
        public static final SimpleField<ChickenSoundVariant> SOUND_VARIANT = SimpleField.<ChickenSoundVariant>builder()
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.CHICKEN_SOUND_VARIANT)
            .build();
        ...
        public static final SimpleField<ChickenVariant> VARIANT = SimpleField.<ChickenVariant>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.CHICKEN_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.CHICKEN_VARIANT)
            .build();
    ...
    public static class CopperGolem extends AbstractGolem {
        ...
        public static final SimpleField<CopperGolemState> COPPER_GOLEM_STATE = SimpleField.<CopperGolemState>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 17, EntityDataTypes.COPPER_GOLEM_STATE)
            .build();
        ...
        public static final SimpleField<WeatheringCopperState> WEATHER_STATE = SimpleField.<WeatheringCopperState>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 16, EntityDataTypes.WEATHERING_COPPER_STATE)
            .build();
    ...
    public static class Cow extends AbstractCow {
        ...
        public static final SimpleField<CowSoundVariant> SOUND_VARIANT = SimpleField.<CowSoundVariant>builder()
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.COW_SOUND_VARIANT)
            .build();
        ...
        public static final SimpleField<CowVariant> VARIANT = SimpleField.<CowVariant>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.COW_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.COW_VARIANT)
            .build();
    ...
    public static class Creaking extends Monster {
        ...
        public static final SimpleField<Boolean> CAN_MOVE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Optional<Vector3i>> HOME_POS = SimpleField.<Optional<Vector3i>>builder()
            .addVersionRange(ClientVersion.V_1_21_4, ClientVersion.V_26_2, 19, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .build();
        ...
        public static final SimpleField<Boolean> IS_ACTIVE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 17, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> IS_TEARING_DOWN = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_4, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Creeper extends Monster {
        ...
        public static final SimpleField<Boolean> IS_IGNITED = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> IS_POWERED = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 17, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final ViewField<Integer, CreeperSwellStateView> SWELL_DIR = ViewField.builder(CreeperSwellStateView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.INT)
            .build();
    ...
    public static class Dolphin extends AgeableWaterCreature {
        ...
        public static final SimpleField<Boolean> GOT_FISH = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_1_21_4, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> MOISNTESS_LEVEL = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_15, 17, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> MOISTNESS_LEVEL = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_1_21_4, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Vector3i> TREASURE_POS = SimpleField.<Vector3i>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 16, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_1_21_4, 17, EntityDataTypes.BLOCK_POSITION)
            .build();
    ...
    public static class Zombie extends Monster {
        ...
        public static final SimpleField<Integer> SPECIAL_TYPE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 17, EntityDataTypes.INT)
            .build();
    ...
    public static class EndCrystal extends Entity {
        ...
        public static final SimpleField<Optional<Vector3i>> BEAM_TARGET = SimpleField.<Optional<Vector3i>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .build();
        ...
        public static final SimpleField<Boolean> SHOW_BOTTOM = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 9, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class EnderMan extends Monster {
        ...
        public static final SimpleField<Integer> CARRY_STATE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.OPTIONAL_BLOCK_STATE)
            .build();
    ...
    public static class SpellcasterIllager extends AbstractIllager {
        ...
        public static final ViewField<Byte, SpellcasterIllagerSpellCastingView> SPELL_CASTING = ViewField.builder(SpellcasterIllagerSpellCastingView::new)
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 17, EntityDataTypes.BYTE)
            .build();
    ...
    public static class ExperienceOrb extends Entity {
        ...
        public static final SimpleField<Integer> VALUE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_26_2, 8, EntityDataTypes.INT)
            .build();
    ...
    public static class FallingBlockEntity extends Entity {
        ...
        public static final SimpleField<Vector3i> START_POS = SimpleField.<Vector3i>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.BLOCK_POSITION)
            .build();
    ...
    public static class FireworkRocketEntity extends Projectile {
        ...
        public static final SimpleField<Optional<Integer>> ATTACHED_TO_TARGET = SimpleField.<Optional<Integer>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.OPTIONAL_INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 9, EntityDataTypes.OPTIONAL_INT)
            .build();
        ...
        public static final SimpleField<Boolean> SHOT_AT_ANGLE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 9, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 10, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class FishingHook extends Projectile {
        ...
        public static final SimpleField<Boolean> BITING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 8, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 9, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> HOOKED_ENTITY = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.INT)
            .build();
    ...
    public static class Fox extends Animal {
         ...
         */
        public static final SimpleField<Byte> FLAGS = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 18, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Optional<UUID>> TRUSTED_0 = SimpleField.<Optional<UUID>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 19, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 19, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.OPTIONAL_UUID)
            .build();
        ...
        public static final SimpleField<Optional<UUID>> TRUSTED_1 = SimpleField.<Optional<UUID>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 20, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 20, EntityDataTypes.OPTIONAL_UUID)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.OPTIONAL_UUID)
            .build();
    ...
    public static class Frog extends Animal {
        ...
        public static final SimpleField<Optional<Integer>> TONGUE_TARGET = SimpleField.<Optional<Integer>>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_21_11, 18, EntityDataTypes.OPTIONAL_INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.OPTIONAL_INT)
            .build();
        ...
        public static final SimpleField<FrogVariant> VARIANT = SimpleField.<FrogVariant>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_20_3, 17, EntityDataTypes.TYPED_FROG_VARIANT)
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.TYPED_FROG_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.TYPED_FROG_VARIANT)
            .build();
    ...
    public static class HangingEntity extends BlockAttachedEntity {
        ...
        public static final SimpleField<BlockFace> DIRECTION = SimpleField.<BlockFace>builder()
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_26_2, 8, EntityDataTypes.BLOCK_FACE)
            .build();
    ...
    public static class ItemFrame extends HangingEntity {
        ...
        public static final SimpleField<ItemStack> ITEM = SimpleField.<ItemStack>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.ITEMSTACK)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_5, 8, EntityDataTypes.ITEMSTACK)
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_26_2, 9, EntityDataTypes.ITEMSTACK)
            .build();
        ...
        public static final SimpleField<Integer> ROTATION = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 8, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_5, 9, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_26_2, 10, EntityDataTypes.INT)
            .build();
    ...
    public static class GlowSquid extends Squid {
        ...
        public static final SimpleField<Integer> DARK_TICKS_REMAINING = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_1_21_11, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class Goat extends Animal {
        ...
        public static final SimpleField<Boolean> HAS_LEFT_HORN = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> HAS_RIGHT_HORN = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_21_11, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> IS_SCREAMING_GOAT = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class HappyGhast extends Animal {
        ...
        public static final SimpleField<Boolean> IS_LEASH_HOLDER = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_1_21_11, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> STAYS_STILL = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Hoglin extends Animal {
         ...
         */
        public static final SimpleField<Boolean> IMMUNE_TO_ZOMBIFICATION = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Horse extends AbstractHorse {
        ...
        public static final SimpleField<Integer> TYPE_VARIANT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.INT)
            .build();
    ...
    public static class Interaction extends Entity {
         ...
         */
        public static final SimpleField<Float> HEIGHT = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_26_2, 9, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Boolean> RESPONSE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_26_2, 10, EntityDataTypes.BOOLEAN)
            .build();
         ...
         */
        public static final SimpleField<Float> WIDTH = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_26_2, 8, EntityDataTypes.FLOAT)
            .build();
    ...
    public static class ItemDisplay extends Display {
        ...
        public static final SimpleField<Byte> ITEM_DISPLAY = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 23, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 24, EntityDataTypes.BYTE)
            .build();
         ...
         */
        public static final SimpleField<ItemStack> ITEM_STACK = SimpleField.<ItemStack>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 22, EntityDataTypes.ITEMSTACK)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 23, EntityDataTypes.ITEMSTACK)
            .build();
    ...
    public static class Llama extends AbstractChestedHorse {
        ...
        public static final SimpleField<Integer> STRENGTH = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> SWAG = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 21, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_20_3, 20, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> VARIANT = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 21, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_19_3, 22, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_20_3, 21, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_1_21_11, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.INT)
            .build();
    ...
    public static class Mannequin extends Avatar {
        ...
        public static final SimpleField<Optional<Component>> DESCRIPTION = SimpleField.<Optional<Component>>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 19, EntityDataTypes.OPTIONAL_ADV_COMPONENT)
            .build();
        ...
        public static final SimpleField<Boolean> IMMOVABLE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<ItemProfile> PROFILE = SimpleField.<ItemProfile>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 17, EntityDataTypes.RESOLVABLE_PROFILE)
            .build();
    ...
    public static class MinecartCommandBlock extends AbstractMinecart {
        ...
        public static final SimpleField<String> COMMAND_NAME = SimpleField.<String>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 13, EntityDataTypes.STRING)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 14, EntityDataTypes.STRING)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_26_2, 13, EntityDataTypes.STRING)
            .build();
        ...
        public static final SimpleField<Component> LAST_OUTPUT = SimpleField.<Component>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 14, EntityDataTypes.ADV_COMPONENT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 15, EntityDataTypes.ADV_COMPONENT)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_26_2, 14, EntityDataTypes.ADV_COMPONENT)
            .build();
    ...
    public static class MinecartFurnace extends AbstractMinecart {
        ...
        public static final SimpleField<Boolean> FUEL = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 13, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 14, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_26_2, 13, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class MushroomCow extends AbstractCow {
        ...
        public static final SimpleField<Integer> TYPE = SimpleField.<Integer>builder()
            ...
            // TODO type changed from 'String' to 'Integer', converter required
            // TODO type changed from 'String' to 'Integer', converter required
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class OminousItemSpawner extends Entity {
         ...
         */
        public static final SimpleField<ItemStack> ITEM = SimpleField.<ItemStack>builder()
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_26_2, 8, EntityDataTypes.ITEMSTACK)
            .build();
    ...
    public static class Painting extends HangingEntity {
        ...
        public static final SimpleField<PaintingVariant> PAINTING_VARIANT = SimpleField.<PaintingVariant>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_1_21_5, 8, EntityDataTypes.PAINTING_VARIANT)
            .addVersionRange(ClientVersion.V_1_21_6, ClientVersion.V_26_2, 9, EntityDataTypes.PAINTING_VARIANT)
            .build();
    ...
    public static class Panda extends Animal {
        ...
        public static final SimpleField<Integer> EAT_COUNTER = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.INT)
            .build();
         ...
         */
        public static final SimpleField<Byte> FLAGS = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 20, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 21, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 22, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 23, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Byte> HIDDEN_GENE = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 19, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 20, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 21, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 22, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Byte> MAIN_GENE = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 20, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Integer> SNEEZE_COUNTER = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.INT)
            .build();
    ...
    public static class Pig extends Animal {
        ...
        public static final SimpleField<Integer> BOOST_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Boolean> SADDLE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 17, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<PigSoundVariant> SOUND_VARIANT = SimpleField.<PigSoundVariant>builder()
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.PIG_SOUND_VARIANT)
            .build();
        ...
        public static final SimpleField<PigVariant> VARIANT = SimpleField.<PigVariant>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 18, EntityDataTypes.PIG_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.PIG_VARIANT)
            .build();
    ...
    public static class Piglin extends AbstractPiglin {
         ...
         */
        public static final SimpleField<Boolean> BABY = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_16_2, ClientVersion.V_1_16_2, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 17, EntityDataTypes.BOOLEAN)
            .build();
         ...
         */
        public static final SimpleField<Boolean> IMMUNE_TO_ZOMBIFICATION = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16, 16, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> IS_CHARGING_CROSSBOW = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> IS_DANCING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Player extends Avatar {
        ...
        public static final SimpleField<Float> PLAYER_ABSORPTION = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 13, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 14, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 15, EntityDataTypes.FLOAT)
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 17, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Byte> PLAYER_MAIN_HAND = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 18, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Byte> PLAYER_MODE_CUSTOMISATION = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 17, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Integer> SCORE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<NBTCompound> SHOULDER_LEFT = SimpleField.<NBTCompound>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.NBT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.NBT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 19, EntityDataTypes.NBT)
            .build();
        ...
        public static final SimpleField<Optional<Integer>> SHOULDER_PARROT_LEFT = SimpleField.<Optional<Integer>>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 19, EntityDataTypes.OPTIONAL_INT)
            .build();
        ...
        public static final SimpleField<Optional<Integer>> SHOULDER_PARROT_RIGHT = SimpleField.<Optional<Integer>>builder()
            .addVersionRange(ClientVersion.V_1_21_9, ClientVersion.V_26_2, 20, EntityDataTypes.OPTIONAL_INT)
            .build();
        ...
        public static final SimpleField<NBTCompound> SHOULDER_RIGHT = SimpleField.<NBTCompound>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.NBT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.NBT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_6, 20, EntityDataTypes.NBT)
            .build();
    ...
    public static class PrimedTnt extends Entity {
         ...
         */
        public static final SimpleField<Integer> BLOCK_STATE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_20_3, ClientVersion.V_26_2, 9, EntityDataTypes.BLOCK_STATE)
            .build();
    ...
    public static class Salmon extends AbstractSchoolingFish {
        ...
        public static final ViewField<Integer, SalmonTypeView> TYPE = ViewField.builder(SalmonTypeView::new)
            // TODO type changed from 'String' to 'Integer', converter required
            .addVersionRange(ClientVersion.V_1_21_4, ClientVersion.V_26_2, 17, EntityDataTypes.INT)
            .build();
    ...
    public static class Shulker extends AbstractGolem {
        ...
        public static final SimpleField<BlockFace> ATTACH_FACE = SimpleField.<BlockFace>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.BLOCK_FACE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.BLOCK_FACE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BLOCK_FACE)
            .build();
        ...
        public static final SimpleField<Optional<Vector3i>> ATTACH_POS = SimpleField.<Optional<Vector3i>>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.OPTIONAL_BLOCK_POSITION)
            .build();
        ...
        public static final SimpleField<Byte> COLOR = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_26_2, 18, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Byte> PEEK = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_26_2, 17, EntityDataTypes.BYTE)
            .build();
    ...
    public static class Slime extends AbstractCubeMob {
        ...
        public static final SimpleField<Integer> ID_SIZE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 14, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 15, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_1, 16, EntityDataTypes.INT)
            .build();
    ...
    public static class Sniffer extends Animal {
        ...
        public static final SimpleField<SnifferState> STATE = SimpleField.<SnifferState>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_21_11, 17, EntityDataTypes.SNIFFER_STATE)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.SNIFFER_STATE)
            .build();
    ...
    public static class Strider extends Animal {
         ...
         */
        public static final SimpleField<Integer> BOOST_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Boolean> SADDLE = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 19, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class SulfurCube extends AbstractCubeMob {
         ...
         */
        public static final SimpleField<Boolean> FROM_BUCKET = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_26_2, ClientVersion.V_26_2, 20, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Integer> MAX_FUSE = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_26_2, ClientVersion.V_26_2, 19, EntityDataTypes.INT)
            .build();
    ...
    public static class TextDisplay extends Display {
        ...
        public static final SimpleField<Integer> BACKGROUND_COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 24, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 25, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> LINE_WIDTH = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 23, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 24, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Byte> STYLE_FLAGS = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 26, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 27, EntityDataTypes.BYTE)
            .build();
        ...
        public static final SimpleField<Component> TEXT = SimpleField.<Component>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 22, EntityDataTypes.ADV_COMPONENT)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 23, EntityDataTypes.ADV_COMPONENT)
            .build();
        ...
        public static final SimpleField<Byte> TEXT_OPACITY = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_19_4, ClientVersion.V_1_19_4, 25, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_20_2, ClientVersion.V_26_2, 26, EntityDataTypes.BYTE)
            .build();
    ...
    public static class ThrownPotion extends ThrowableItemProjectile {
         ...
         */
        public static final SimpleField<ItemStack> ITEM_STACK = SimpleField.<ItemStack>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_15, 7, EntityDataTypes.ITEMSTACK)
            .build();
    ...
    public static class ThrownTrident extends AbstractArrow {
        ...
        public static final SimpleField<Boolean> ID_FOIL = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_15, 11, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 10, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 11, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 12, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Byte> ID_LOYALTY = SimpleField.<Byte>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_15, 10, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 9, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21, 10, EntityDataTypes.BYTE)
            .addVersionRange(ClientVersion.V_1_21_2, ClientVersion.V_26_2, 11, EntityDataTypes.BYTE)
            .build();
    ...
    public static class Turtle extends Animal {
        ...
        public static final SimpleField<Boolean> GOING_HOME = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 20, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 21, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> HAS_EGG = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 17, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 18, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Vector3i> HOME_POS = SimpleField.<Vector3i>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 15, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 16, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 17, EntityDataTypes.BLOCK_POSITION)
            .build();
        ...
        public static final SimpleField<Boolean> LAYING_EGG = SimpleField.<Boolean>builder()
            ...
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Boolean> TRAVELLING = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 20, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 21, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 22, EntityDataTypes.BOOLEAN)
            .build();
        ...
        public static final SimpleField<Vector3i> TRAVEL_POS = SimpleField.<Vector3i>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.BLOCK_POSITION)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_4, 20, EntityDataTypes.BLOCK_POSITION)
            .build();
    ...
    public static class Villager extends AbstractVillager {
        ...
        public static final SimpleField<VillagerData> VILLAGER_DATA = SimpleField.<VillagerData>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.VILLAGER_DATA)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.VILLAGER_DATA)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 18, EntityDataTypes.VILLAGER_DATA)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 19, EntityDataTypes.VILLAGER_DATA)
            .build();
    ...
    public static class Warden extends Monster {
        ...
        public static final SimpleField<Integer> CLIENT_ANGER_LEVEL = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_19, ClientVersion.V_26_2, 16, EntityDataTypes.INT)
            .build();
    ...
    public static class WitherBoss extends Monster {
        ...
        public static final SimpleField<Integer> INV = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 18, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 19, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<Integer> TARGET_C = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 16, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 17, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 18, EntityDataTypes.INT)
            .build();
    ...
    public static class WitherSkull extends AbstractHurtingProjectile {
        ...
        public static final SimpleField<Boolean> DANGEROUS = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 7, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 8, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class Wolf extends TamableAnimal {
         ...
         */
        public static final SimpleField<Long> ANGER_END_TIME = SimpleField.<Long>builder()
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_1_21_11, 21, EntityDataTypes.LONG)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 22, EntityDataTypes.LONG)
            .build();
         ...
         */
        public static final SimpleField<Integer> COLLAR_COLOR = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 19, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.INT)
            .build();
         ...
         */
        public static final SimpleField<Float> HEALTH = SimpleField.<Float>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 17, EntityDataTypes.FLOAT)
            .build();
        ...
        public static final SimpleField<Boolean> INTERESTED = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_16_2, 18, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_11, 19, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 20, EntityDataTypes.BOOLEAN)
            .build();
         ...
         */
        public static final SimpleField<Integer> REMAINING_ANGER_TIME = SimpleField.<Integer>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 20, EntityDataTypes.INT)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_1_21_9, 21, EntityDataTypes.INT)
            .build();
        ...
        public static final SimpleField<WolfSoundVariant> SOUND_VARIANT = SimpleField.<WolfSoundVariant>builder()
            .addVersionRange(ClientVersion.V_1_21_5, ClientVersion.V_1_21_11, 23, EntityDataTypes.WOLF_SOUND_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 24, EntityDataTypes.WOLF_SOUND_VARIANT)
            .build();
        ...
        public static final SimpleField<WolfVariant> VARIANT = SimpleField.<WolfVariant>builder()
            .addVersionRange(ClientVersion.V_1_20_5, ClientVersion.V_1_21_11, 22, EntityDataTypes.TYPED_WOLF_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 23, EntityDataTypes.TYPED_WOLF_VARIANT)
            .build();
    ...
    public static class Zoglin extends Monster {
         ...
         */
        public static final SimpleField<Boolean> BABY = SimpleField.<Boolean>builder()
            .addVersionRange(ClientVersion.V_1_16, ClientVersion.V_1_16_2, 15, EntityDataTypes.BOOLEAN)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 16, EntityDataTypes.BOOLEAN)
            .build();
    ...
    public static class ZombieNautilus extends AbstractNautilus {
        ...
        public static final SimpleField<ZombieNautilusVariant> VARIANT = SimpleField.<ZombieNautilusVariant>builder()
            .addVersionRange(ClientVersion.V_1_21_11, ClientVersion.V_1_21_11, 20, EntityDataTypes.ZOMBIE_NAUTILUS_VARIANT)
            .addVersionRange(ClientVersion.V_26_1, ClientVersion.V_26_2, 21, EntityDataTypes.ZOMBIE_NAUTILUS_VARIANT)
            .build();
    ...
    public static class ZombieVillager extends Zombie {
         ...
         */
        public static final SimpleField<VillagerData> VILLAGER_DATA = SimpleField.<VillagerData>builder()
            .addVersionRange(ClientVersion.V_1_14_4, ClientVersion.V_1_14_4, 18, EntityDataTypes.VILLAGER_DATA)
            .addVersionRange(ClientVersion.V_1_15, ClientVersion.V_1_16_2, 19, EntityDataTypes.VILLAGER_DATA)
            .addVersionRange(ClientVersion.V_1_17, ClientVersion.V_26_2, 20, EntityDataTypes.VILLAGER_DATA)
            .build();
