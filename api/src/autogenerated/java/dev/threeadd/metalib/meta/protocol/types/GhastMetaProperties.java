 ...
 */
public class GhastMetaProperties extends MobMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> IS_CHARGING = SimpleProperty.<Boolean>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = MobMetaProperties.SCHEMA.extend(EntityTypes.GHAST)
        .add(GhastMetaProperties.IS_CHARGING)
        .build();
