...
public class TropicalFishMetaProperties extends AbstractSchoolingFishMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> TYPE_VARIANT = SimpleProperty.<Integer>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AbstractSchoolingFishMetaProperties.SCHEMA.extend(EntityTypes.TROPICAL_FISH)
        .add(TropicalFishMetaProperties.TYPE_VARIANT)
        .build();
