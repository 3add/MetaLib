...
public class PandaMetaProperties extends AnimalMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> EAT_COUNTER = SimpleProperty.<Integer>builder()
    ...
    public static final SimpleProperty<Byte> FLAGS = SimpleProperty.<Byte>builder()
        ...
        .addVersion(ClientVersion.V_26_2, 23, EntityDataTypes.BYTE)
    .build();
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Byte> HIDDEN_GENE = SimpleProperty.<Byte>builder()
        ...
        .addVersion(ClientVersion.V_26_2, 22, EntityDataTypes.BYTE)
    .build();
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Byte> MAIN_GENE = SimpleProperty.<Byte>builder()
        ...
        .addVersion(ClientVersion.V_26_2, 21, EntityDataTypes.BYTE)
    .build();
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> SNEEZE_COUNTER = SimpleProperty.<Integer>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> UNHAPPY_COUNTER = SimpleProperty.<Integer>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AnimalMetaProperties.SCHEMA.extend(EntityTypes.PANDA)
        .add(PandaMetaProperties.EAT_COUNTER)
        .add(PandaMetaProperties.FLAGS)
        .add(PandaMetaProperties.HIDDEN_GENE)
        .add(PandaMetaProperties.MAIN_GENE)
        .add(PandaMetaProperties.SNEEZE_COUNTER)
        .add(PandaMetaProperties.UNHAPPY_COUNTER)
        .build();
