...
import dev.threeadd.metalib.meta.protocol.enums.view.EnderDragonPhaseView;
...
public class EnderDragonMetaProperties extends MobMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final ViewProperty<Integer, EnderDragonPhaseView> PHASE = ViewProperty.builder(EnderDragonPhaseView::new)
     ...
     */
    public static final MetadataSchema SCHEMA = MobMetaProperties.SCHEMA.extend(EntityTypes.ENDER_DRAGON)
        .add(EnderDragonMetaProperties.PHASE)
        .build();
