...
public class ThrowableItemProjectileMetaProperties extends ThrowableProjectileMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = ThrowableProjectileMetaProperties.SCHEMA.extend(null) // TODO Entity Type need mappings
        .add(ThrowableItemProjectileMetaProperties.ITEM_STACK)
        .build();
