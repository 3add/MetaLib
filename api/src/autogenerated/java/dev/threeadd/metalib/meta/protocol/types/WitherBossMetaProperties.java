...
public class WitherBossMetaProperties extends MonsterMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> INV = SimpleProperty.<Integer>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> TARGET_A = SimpleProperty.<Integer>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> TARGET_B = SimpleProperty.<Integer>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> TARGET_C = SimpleProperty.<Integer>builder()
    ...
    public static final MetadataSchema SCHEMA = MonsterMetaProperties.SCHEMA.extend(null) // TODO Entity Type need mappings
        .add(WitherBossMetaProperties.INV)
        .add(WitherBossMetaProperties.TARGET_A)
        .add(WitherBossMetaProperties.TARGET_B)
        .add(WitherBossMetaProperties.TARGET_C)
        .build();
