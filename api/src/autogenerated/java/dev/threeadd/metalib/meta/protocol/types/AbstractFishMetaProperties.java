...
public class AbstractFishMetaProperties extends WaterAnimalMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = WaterAnimalMetaProperties.SCHEMA.extend(EntityTypes.ABSTRACT_FISHES)
        .add(AbstractFishMetaProperties.FROM_BUCKET)
        .build();
