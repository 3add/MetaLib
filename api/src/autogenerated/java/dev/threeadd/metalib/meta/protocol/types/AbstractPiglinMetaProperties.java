...
public class AbstractPiglinMetaProperties extends MonsterMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = MonsterMetaProperties.SCHEMA.extend(EntityTypes.ABSTRACT_PIGLIN)
        .add(AbstractPiglinMetaProperties.IMMUNE_TO_ZOMBIFICATION)
        .build();
