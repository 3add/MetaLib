...
public class PillagerMetaProperties extends AbstractIllagerMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = AbstractIllagerMetaProperties.SCHEMA.extend(EntityTypes.PILLAGER)
        .add(PillagerMetaProperties.IS_CHARGING_CROSSBOW)
        .build();
