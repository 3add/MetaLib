...
import dev.threeadd.metalib.meta.protocol.bitmask.view.BlazeFlagsView;
...
public class BlazeMetaProperties extends MonsterMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final ViewProperty<Byte, BlazeFlagsView> FLAGS = ViewProperty.builder(BlazeFlagsView::new)
     ...
     */
    public static final MetadataSchema SCHEMA = MonsterMetaProperties.SCHEMA.extend(EntityTypes.BLAZE)
        .add(BlazeMetaProperties.FLAGS)
        .build();
