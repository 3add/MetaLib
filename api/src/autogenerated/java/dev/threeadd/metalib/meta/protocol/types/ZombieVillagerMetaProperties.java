...
public class ZombieVillagerMetaProperties extends ZombieMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> CONVERTING = SimpleProperty.<Boolean>builder()
    ...
    public static final SimpleProperty<VillagerData> VILLAGER_DATA = SimpleProperty.<VillagerData>builder()
        ...
        .addVersion(ClientVersion.V_26_2, 20, EntityDataTypes.VILLAGER_DATA)
    .build();
     ...
     */
    public static final MetadataSchema SCHEMA = ZombieMetaProperties.SCHEMA.extend(EntityTypes.ZOMBIE_VILLAGER)
        .add(ZombieVillagerMetaProperties.CONVERTING)
        .add(ZombieVillagerMetaProperties.VILLAGER_DATA)
        .add(ZombieVillagerMetaProperties.VILLAGER_FINALIZED)
        .build();
