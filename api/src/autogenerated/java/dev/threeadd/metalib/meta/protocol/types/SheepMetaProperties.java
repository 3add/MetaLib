...
public class SheepMetaProperties extends AnimalMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Byte> WOOL = SimpleProperty.<Byte>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AnimalMetaProperties.SCHEMA.extend(EntityTypes.SHEEP)
        .add(SheepMetaProperties.WOOL)
        .build();
