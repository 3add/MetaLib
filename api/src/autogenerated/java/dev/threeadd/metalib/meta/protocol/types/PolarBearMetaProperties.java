...
public class PolarBearMetaProperties extends AnimalMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> STANDING = SimpleProperty.<Boolean>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AnimalMetaProperties.SCHEMA.extend(EntityTypes.POLAR_BEAR)
        .add(PolarBearMetaProperties.STANDING)
        .build();
