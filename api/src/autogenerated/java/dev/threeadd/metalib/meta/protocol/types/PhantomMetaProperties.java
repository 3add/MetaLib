 ...
 */
public class PhantomMetaProperties extends MobMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = MobMetaProperties.SCHEMA.extend(EntityTypes.PHANTOM)
        .add(PhantomMetaProperties.ID_SIZE)
        .build();
