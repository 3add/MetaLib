 ...
 */
public class SlimeMetaProperties extends AbstractCubeMobMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = AbstractCubeMobMetaProperties.SCHEMA.extend(EntityTypes.SLIME)
        .add(SlimeMetaProperties.ID_SIZE)
        .build();
