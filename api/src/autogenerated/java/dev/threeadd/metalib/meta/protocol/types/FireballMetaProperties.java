...
public class FireballMetaProperties extends AbstractHurtingProjectileMetaProperties {
     ...
     */
    public static final MetadataSchema SCHEMA = AbstractHurtingProjectileMetaProperties.SCHEMA.extend(EntityTypes.FIREBALL)
        .add(FireballMetaProperties.ITEM_STACK)
        .build();
