...
public class OcelotMetaProperties extends AnimalMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> TRUSTING = SimpleProperty.<Boolean>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AnimalMetaProperties.SCHEMA.extend(EntityTypes.OCELOT)
        .add(OcelotMetaProperties.TRUSTING)
        .build();
