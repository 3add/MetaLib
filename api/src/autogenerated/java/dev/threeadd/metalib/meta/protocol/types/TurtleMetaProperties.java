...
public class TurtleMetaProperties extends AnimalMetaProperties {
     ...
     */
    public static final SimpleProperty<Boolean> GOING_HOME = SimpleProperty.<Boolean>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> HAS_EGG = SimpleProperty.<Boolean>builder()
     ...
     * <p>Supported Versions: {@code 1.21.4-}</p>
     */
    public static final SimpleProperty<Vector3i> HOME_POS = SimpleProperty.<Vector3i>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> LAYING_EGG = SimpleProperty.<Boolean>builder()
     ...
     * <p>Supported Versions: {@code 1.21.4-}</p>
     */
    public static final SimpleProperty<Boolean> TRAVELLING = SimpleProperty.<Boolean>builder()
     ...
     * <p>Supported Versions: {@code 1.21.4-}</p>
     */
    public static final SimpleProperty<Vector3i> TRAVEL_POS = SimpleProperty.<Vector3i>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = AnimalMetaProperties.SCHEMA.extend(EntityTypes.TURTLE)
        .add(TurtleMetaProperties.GOING_HOME)
        .add(TurtleMetaProperties.HAS_EGG)
        .add(TurtleMetaProperties.HOME_POS)
        .add(TurtleMetaProperties.LAYING_EGG)
        .add(TurtleMetaProperties.TRAVELLING)
        .add(TurtleMetaProperties.TRAVEL_POS)
        .build();
