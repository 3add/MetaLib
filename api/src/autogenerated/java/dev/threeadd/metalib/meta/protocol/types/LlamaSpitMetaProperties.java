 ...
 */
public class LlamaSpitMetaProperties extends ProjectileMetaProperties {

    /**
     * The {@link MetadataSchema} containing this meta's properties, combined with all
     * properties declared by its super classes.
     */
    public static final MetadataSchema SCHEMA = ProjectileMetaProperties.SCHEMA.extend(EntityTypes.LLAMA_SPIT)
        .build();
