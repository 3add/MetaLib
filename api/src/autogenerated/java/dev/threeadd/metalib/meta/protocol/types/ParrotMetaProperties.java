...
import dev.threeadd.metalib.meta.protocol.enums.view.ParrotVariantView;
...
public class ParrotMetaProperties extends ShoulderRidingEntityMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final ViewProperty<Integer, ParrotVariantView> VARIANT = ViewProperty.builder(ParrotVariantView::new)
     ...
     */
    public static final MetadataSchema SCHEMA = ShoulderRidingEntityMetaProperties.SCHEMA.extend(EntityTypes.PARROT)
        .add(ParrotMetaProperties.VARIANT)
        .build();
