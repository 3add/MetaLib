...
public class GuardianMetaProperties extends MonsterMetaProperties {
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Integer> ATTACK_TARGET = SimpleProperty.<Integer>builder()
     ...
     * <p>Supported Versions: {@code All Supported Versions}</p>
     */
    public static final SimpleProperty<Boolean> MOVING = SimpleProperty.<Boolean>builder()
     ...
     */
    public static final MetadataSchema SCHEMA = MonsterMetaProperties.SCHEMA.extend(EntityTypes.GUARDIAN)
        .add(GuardianMetaProperties.ATTACK_TARGET)
        .add(GuardianMetaProperties.MOVING)
        .build();
