package dev.threeadd.metalib.util;
...
public final class PacketDispatcher {
    ...
    public static void sendPacket(UUID userId, @Nullable PacketWrapper<?> wrapper) {
        ...
        if (channel == null) {
            MetaLib.getPlatform().getLogger().warning("Failed to send packet to " + userId + " because the channel was null. They may be disconnected/not online.");
            return;
        }
