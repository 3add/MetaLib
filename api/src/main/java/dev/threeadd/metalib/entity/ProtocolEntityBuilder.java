...
public class ProtocolEntityBuilder {
    ...
    @Nullable UUID uuid;
    @Nullable ObjectData objectData;
    @Nullable EntityMetadata meta;
    ...
    private ProtocolEntityBuilder(EntityType entityType, @Nullable ExtensionManagerBuilder extensionManagerBuilder) {
        ...
        this.meta = new EntityMetadata(MetadataSchemaRegistry.getSchema(entityType));
    }
    ...
    /**
     * @param objectData the <a href="https://minecraft.wiki/w/Java_Edition_protocol/Object_data">object data</a> of this entity
     *                   this will default to {@link dev.threeadd.metalib.entity.data.EmptyObjectData}
     * @return this builder for chaining
     * @see dev.threeadd.metalib.entity.data
     */
    public ProtocolEntityBuilder objectData(@Nullable ObjectData objectData) {
     ...
     *             this will default to a new empty {@link EntityMetadata} object
     * @return this builder for chaining
     * @throws NullPointerException if the provided {@code meta} is null
     */
    public ProtocolEntityBuilder meta(@Nullable EntityMetadata meta) {
        this.meta = Objects.requireNonNull(meta, "EntityMetadata must not be null");
        return this;
    }

    /**
     * Configure the entity meta for this entity using {@link EntityMetadata}
     * If a meta was not set before this using {@link #meta(EntityMetadata)},
     * a new empty {@link EntityMetadata} object will be created for you, which is then consumed.
     *
     * @param config the config for the entity metadata
     * @return this builder for chaining
     * @throws NullPointerException if the provided {@code config} is null
     */
    public ProtocolEntityBuilder meta(Consumer<EntityMetadata> config) {
        if (this.meta == null) {
            this.meta = new EntityMetadata(MetadataSchemaRegistry.getSchema(this.entityType));
        }
