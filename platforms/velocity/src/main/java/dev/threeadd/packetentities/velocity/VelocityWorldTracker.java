...
public class VelocityWorldTracker extends PacketListenerAbstract {
    ...
    private final Map<User, PlatformWorld> userWorlds = new ConcurrentHashMap<>();
    ...
    public void onPacketSend(PacketSendEvent event) {
        ...
        if (event.getPacketType() == PacketType.Play.Server.JOIN_GAME) {
            ...
            this.userWorlds.put(user, PlatformWorld.of(worldName));
            ...
            worldName.ifPresent(string -> this.userWorlds.put(user, PlatformWorld.of(string)));
        }
    }
    ...
    public PlatformWorld getWorld(User user) {
