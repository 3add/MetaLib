...
public class JavadocGenerator {
    ...
    public CodeBlock generateClassJavadoc(MetadataNode node) {
    ...
    public CodeBlock generatePropertyJavadoc(PropertyNode prop, ClassName viewClass) {
        CodeBlock.Builder builder = CodeBlock.builder();
        ...
        String versionsRange = getVersionRangeString(prop.getVersions().keySet());
        if (!versionsRange.isEmpty()) {
            builder.add("<p>Supported Versions: {@code $L}</p>\n", versionsRange);
        }
